...
public class MatchWeights {
    ...
    public static final Map<String, Double> CONFIG = Map.ofEntries(
            entry("offense.xG", 1.2),
            entry("offense.xA", 0.5),
            entry("offense.xT", 0.7),
            entry("offense.successfulDribbles", 0.05),
            entry("offense.progressivePasses", 0.03),
            entry("offense.push", 1.6),
            entry("offense.factor", 200.0),
            entry("defense.tackles", 0.6),
            entry("defense.interceptions", 0.5),
            entry("defense.clearances", 0.4),
            entry("defense.blocks", 0.3),
            entry("defense.push", 1.6),
            entry("defense.factor", 200.0),
            entry("goals.min", 0.1),
            entry("goals.max", 3.0)
    );
}